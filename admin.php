    ...
    <div class="row w-100">
      <div class="col-3">
        ...
        <div class="nav flex-column nav-tabs text-center" id="v-tabs-tab" role="tablist" aria-orientation="vertical">
          <a class="nav-link <?= isset($_GET["uploadSuccess"]) || empty($_GET) ? 'active' : '' ?>" id="v-tabs-upload-listing-tab" data-mdb-toggle="tab" href="#v-tabs-upload-listing" role="tab" aria-controls="v-tabs-upload-listing" aria-selected="true">Upload listing</a>
          <a class="nav-link <?= isset($_GET["manageSuccess"]) ? 'active' : '' ?>" id="v-tabs-manage-listing-tab" data-mdb-toggle="tab" href="#v-tabs-manage-listing" role="tab" aria-controls="v-tabs-manage-listing" aria-selected="false">Manage listing</a>
      ...
      <div class="col-9">
        ...
        <div class="tab-content" id="v-tabs-tabContent">
          <div class="tab-pane fade <?= isset($_GET["uploadSuccess"]) || empty($_GET) ? 'active show' : '' ?>" id="v-tabs-upload-listing" role="tabpanel" aria-labelledby="v-tabs-upload-listing-tab">
            <form action="process_adminUpload" method="post" target="_self" enctype="multipart/form-data" style="width: 60%;">
              ...
              <div class="form-outline mb-4">
                <input type="text" class="form-control form-control-lg" id="item-name" name="item-name" value="<?= $_SESSION["itemname"] ?? '' ?>" maxlength="20" required>
                <label for="item-name" class="form-label">Item name</label>
              </div>

              <div class="form-outline mb-4">
                <textarea class="form-control form-control-lg " data-mdb-showcounter="true" id="item-desc" name="item-desc" maxlength="500" style="height: 10rem;" required><?= $_SESSION["itemdesc"] ?? '' ?></textarea>
                <label for="item-desc" class="form-label">Description</label>
                <div class="form-helper"></div>
              </div>

              <div class="form-outline mb-4">
                <textarea class="form-control form-control-lg " data-mdb-showcounter="true" id="item-details" name="item-details" maxlength="200" style="height: 7rem;"><?= $_SESSION["itemdetails"] ?? '' ?></textarea>
                <label for="item-details" class="form-label">More details (Not required)</label>
                <div class="form-helper"></div>
              </div>

              <div class="form-outline mb-4">
                <textarea class="form-control form-control-lg " data-mdb-showcounter="true" id="item-materials" name="item-materials" maxlength="200" style="height: 7rem;" required><?= $_SESSION["itemmaterials"] ?? '' ?></textarea>
              ...
              <select class="form-select mb-3 item-category" name="item-category" aria-label="Item category" required>
                <option disabled <?= !isset($_SESSION["itemcat"]) ? 'selected' : '' ?>>Category</option>
                <option <?= isset($_SESSION["itemcat"]) && $_SESSION["itemcat"] === "clothing" ? 'selected' : '' ?> value="clothing">Clothing</option>
                <option <?= isset($_SESSION["itemcat"]) && $_SESSION["itemcat"] === "bags" ? 'selected' : '' ?> value="bags">Bags</option>
                <option <?= isset($_SESSION["itemcat"]) && $_SESSION["itemcat"] === "accessories" ? 'selected' : '' ?> value="accessories">Accessories</option>
              </select>

              <div class="form-outline mb-3">
                <input type="tel" class="form-control form-control-lg" id="item-price" name="item-price" value="<?= $_SESSION["itemprice"] ?? '' ?>" maxlength="10" required>
              ...
              <select class="form-select mb-3" name="item-type" aria-label="Item type" required>
                ...
                <option <?= isset($_SESSION["itemtype"]) && $_SESSION["itemtype"] === "unisex" ? 'selected' : '' ?> value="unisex">Unisex</option>
                <option <?= isset($_SESSION["itemtype"]) && $_SESSION["itemtype"] === "men" ? 'selected' : '' ?> value="men">Men</option>
                <option <?= isset($_SESSION["itemtype"]) && $_SESSION["itemtype"] === "women" ? 'selected' : '' ?> value="women">Women</option>
              </select>

              <label class="form-label" for="item-size">Stock</label>
              <div class="d-flex flex-row justify-content-between">
                <div class="form-outline mb-4 me-3 item-size">
                  <input type="number" class="form-control form-control-lg" id="item-size-XS" name="item-size-XS" min=0 value="<?= $_SESSION["xs"] ?? '' ?>">
                  <label for="item-size-XS" class="form-label">XS</label>
                </div>
                <div class="form-outline mb-4 me-3 item-size">
                  <input type="number" class="form-control form-control-lg" id="item-size-S" name="item-size-S" min=0 value="<?= $_SESSION["s"] ?? '' ?>">
                  <label for="item-size-S" class="form-label">S</label>
                </div>
                <div class="form-outline mb-4 me-3 item-size">
                  <input type="number" class="form-control form-control-lg" id="item-size-M" name="item-size-M" min=0 value="<?= $_SESSION["m"] ?? '' ?>">
                  <label for="item-size-M" class="form-label">M</label>
                </div>
                <div class="form-outline mb-4 me-3 item-size">
                  <input type="number" class="form-control form-control-lg" id="item-size-L" name="item-size-L" min=0 value="<?= $_SESSION["l"] ?? '' ?>">
                  <label for="item-size-L" class="form-label">L</label>
                </div>
                <div class="form-outline mb-4 item-size">
                  <input type="number" class="form-control form-control-lg" id="item-size-XL" name="item-size-XL" min=0 value="<?= $_SESSION["xl"] ?? '' ?>">
          ...
          <div class="tab-pane fade <?= isset($_GET["manageSuccess"]) ? 'show active' : '' ?>" id="v-tabs-manage-listing" role="tabpanel" aria-labelledby="v-tabs-manage-listing-tab">
            <?php
            ...
            <form action="process_adminItemEdit" method="post" target="_self" enctype="multipart/form-data" style="width: 60%;">
              ...
              <div class="edit-container">
                ...
                <div class="form-outline mb-4">
                  <input type="text" class="form-control form-control-lg" id="manage-item-name" name="manage-item-name" maxlength="20" value="<?= $_SESSION["manageItemName"] ?? '' ?>">
                  <label for="manage-item-name" class="form-label">Change Item name</label>
                </div>
                <div class="form-outline mb-4">
                  <textarea class="form-control form-control-lg " data-mdb-showcounter="true" id="manage-item-desc" name="manage-item-desc" maxlength="500" style="height: 10rem;"><?= $_SESSION["manageItemDesc"] ?? '' ?></textarea>
                  <label for="manage-item-desc" class="form-label">Change Description</label>
                  <div class="form-helper"></div>
                </div>
                <div class="form-outline mb-4">
                  <textarea class="form-control form-control-lg " data-mdb-showcounter="true" id="manage-item-details" name="manage-item-details" maxlength="200" style="height: 7rem;"><?= $_SESSION["manageItemDetails"] ?? '' ?></textarea>
                  <label for="manage-item-details" class="form-label">Change More Details</label>
                  <div class="form-helper"></div>
                </div>
                <div class="form-outline mb-4">
                  <textarea class="form-control form-control-lg " data-mdb-showcounter="true" id="manage-item-materials" name="manage-item-materials" maxlength="200" style="height: 7rem;"><?= $_SESSION["manageItemMaterials"] ?? '' ?></textarea>
                ...
                <div class="form-outline mb-3">
                  <input type="tel" class="form-control form-control-lg" id="manage-item-price" name="manage-item-price" value="<?= $_SESSION["manageItemPrice"] ?? '' ?>" maxlength="10">
                ...
                <div class="d-flex flex-row justify-content-between">
                  <div class="form-outline mb-4 me-3">
                    <input type="number" class="form-control form-control-lg" id="manage-item-size-XS" name="manage-item-size-XS" min=0 value="<?= $_SESSION["manageXs"] ?? '' ?>">
                    <label for="manage-item-size-XS" class="form-label">XS</label>
                  </div>
                  <div class="form-outline mb-4 me-3">
                    <input type="number" class="form-control form-control-lg" id="manage-item-size-S" name="manage-item-size-S" min=0 value="<?= $_SESSION["manageS"] ?? '' ?>">
                    <label for="manage-item-size-S" class="form-label">S</label>
                  </div>
                  <div class="form-outline mb-4 me-3">
                    <input type="number" class="form-control form-control-lg" id="manage-item-size-M" name="manage-item-size-M" min=0 value="<?= $_SESSION["manageM"] ?? '' ?>">
                    <label for="manage-item-size-M" class="form-label">M</label>
                  </div>
                  <div class="form-outline mb-4 me-3">
                    <input type="number" class="form-control form-control-lg" id="manage-item-size-L" name="manage-item-size-L" min=0 value="<?= $_SESSION["manageL"] ?? '' ?>">
                    <label for="manage-item-size-L" class="form-label">L</label>
                  </div>
                  <div class="form-outline mb-4">
                    <input type="number" class="form-control form-control-lg" id="manage-item-size-XL" name="manage-item-size-XL" min=0 value="<?= $_SESSION["manageXl"] ?? '' ?>">
              ...
              <div class="form-outline mb-4 item-name">
                <input type="password" class="form-control form-control-lg" id="manage-admin-key" name="manage-admin-key" required>
          ...
          <div class="tab-pane fade" id="v-tabs-users" role="tabpanel" aria-labelledby="v-tabs-users-tab">
            <form action="process_adminUserEdit" method="post" target="_self" style="width: 60%;">
              ...
              ?>
              <div class="form-outline mb-3">
                <input type="text" class="form-control form-control-lg" id="mng-user-name" name="mng-user-name" value="<?= $_SESSION["mngUserName"] ?? '' ?>" maxlength="20" required>
                <label for="mng-user-name" class="form-label">Username/UserID</label>
              </div>
              <select class="form-select mb-3 manage-user-action" name="manage-user-action" aria-label="Manage User Action">
                <option value="Suspend">Suspend</option>
                <option value="Unsuspend">Unsuspend</option>
                <option value="Delete">Delete</option>
              </select>
              <div class="form-outline mb-3 item-name">
                <input type="password" class="form-control form-control-lg" id="user-admin-key" name="user-admin-key" required>
