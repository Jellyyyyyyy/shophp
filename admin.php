    ...
    <div class="row w-100">
      <div class="col-3">
        ...
        <div class="nav flex-column nav-tabs text-center" id="v-tabs-tab" role="tablist" aria-orientation="vertical">
          ...
          <a class="nav-link" id="v-tabs-manage-admin" data-mdb-toggle="tab" href="#v-tabs-manage-admin" role="tab"
            aria-controls="v-tabs-manage-admin" aria-selected="false">Manage admins</a>
        </div>
        <!-- Tab navs -->
      </div>
