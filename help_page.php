    ...
    <div class="row w-100">
      <div class="col-3">
        ...
        <div class="nav flex-column nav-tabs text-center" id="v-tabs-tab" role="tablist" aria-orientation="vertical">
          <a class="nav-link <?php echo strpos($_SERVER["REQUEST_URI"], "faq") !== false ||  strpos($_SERVER["REQUEST_URI"], "help") !== false ? 'active' : '' ?>"
            id="v-tabs-FAQ-tab" data-mdb-toggle="tab" href="#v-tabs-FAQ" role="tab" aria-controls="v-tabs-FAQ"
            aria-selected="true">FAQ</a>

          <a class="nav-link <?php echo strpos($_SERVER["REQUEST_URI"], "returnpolicy") !== false ||  strpos($_SERVER["REQUEST_URI"], "refundpolicy") !== false ? 'active' : '' ?>"
            id="v-tabs-return-policy-tab" data-mdb-toggle="tab" href="#v-tabs-return-policy" role="tab"
            aria-controls="v-tabs-return-policy" aria-selected="false">Return Policy</a>

          <a class="nav-link <?php echo strpos($_SERVER["REQUEST_URI"], "privacypolicy") !== false ? 'active' : '' ?>"
            id="v-tabs-privacy-policy-tab" data-mdb-toggle="tab" href="#v-tabs-privacy-policy" role="tab"
            aria-controls="v-tabs-privacy-policy" aria-selected="false">Privacy policy</a>

          <a class="nav-link <?php echo strpos($_SERVER["REQUEST_URI"], "eula") !== false ? 'active' : '' ?>"
            id="v-tabs-eula4lyf3-tab" data-mdb-toggle="tab" href="#v-tabs-eula4lyf3" role="tab"
            aria-controls="v-tabs-eula4lyf3" aria-selected="false">EULA</a>
      ...
      <div class="col-9">
        ...
        <div class="tab-content" id="v-tabs-tabContent">
          <div
            class="tab-pane fade <?php echo strpos($_SERVER["REQUEST_URI"], "faq") !== false ||  strpos($_SERVER["REQUEST_URI"], 'help') !== false ? 'show active' : '' ?>"
            id="v-tabs-FAQ" role="tabpanel" aria-labelledby="v-tabs-FAQ-tab">
            <h1>FAQ</h1>
            <ul>
              <li>
              ...
              <li>
                ...
                <p>A: Check our refund policy and if you think it's suitable for refund, contact us @ admin@shophp.shop
                </p>
              </li>
              <li>
              ...
              <li>
                ...
                <p>A: We will send you an email upon delivering your order. Your order progress will be trackable in the
                  link provided in the email.</p>
              </li>
              <li>
          ...
          <div
            class="tab-pane fade <?php echo strpos($_SERVER["REQUEST_URI"], "returnpolicy") !== false ||  strpos($_SERVER["REQUEST_URI"], "refundpolicy") !== false ? 'show active' : '' ?>"
            id="v-tabs-return-policy" role="tabpanel" aria-labelledby="v-tabs-return-policy-tab">
            ...
            <ul>
              <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                  &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to LeryLoiCompany LLC, Kitchen.</p>
              </li>
              <li>
              ...
              <li>
                <p><strong>Website</strong> refers to shoPHP, accessible from <a href="shoPHP.shop"
                    rel="external nofollow noopener" target="_blank">shoPHP.shop</a></p>
              </li>
              <li>
          ...
          <div
            class="tab-pane fade <?php echo strpos($_SERVER["REQUEST_URI"], "privacypolicy") !== false ? 'show active' : '' ?>"
            id="v-tabs-privacy-policy" role="tabpanel" aria-labelledby="v-tabs-privacy-policy-tab">
            ...
            <ul>
              ...
              <li>
                <p><strong>Usage Data</strong> refers to data collected automatically, either generated by the use of
                  the Service or from the Service infrastructure itself (for example, the duration of a page visit).</p>
              </li>
              <li>
                <p><strong>Website</strong> refers to shoPHP, accessible from <a href="www.shophp.shop"
                    rel="external nofollow noopener" target="_blank">www.shophp.shop</a></p>
              </li>
              <li>
                <p><strong>You</strong> means the individual accessing or using the Service, or the company, or other
                  legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
          ...
          <div
            class="tab-pane fade <?php echo strpos($_SERVER["REQUEST_URI"], "eula") !== false ? 'show active' : '' ?>"
            id="v-tabs-eula4lyf3" role="tabpanel" aria-labelledby="v-tabs-eula4lyf3-tab">
            <h1>End-User License Agreement (&quot;Agreement&quot;)</h1>
            <p>Last updated: November 13, 2022</p>
            <p>Please read this End-User License Agreement carefully before being a Karen, downloading or using shoPHP.
            </p>
            <h1>Interpretation and Definitions</h1>
            <h2>Interpretation</h2>
            <p>The words of which the initial letter is capitalized have meanings defined under the following
            ...
            <ul>
              <li>
                <p><strong>Agreement</strong> means this End-User License Agreement that forms the entire agreement
                  between You and the Company regarding the use of the Application.</p>
              </li>
              <li>
                <p><strong>Application</strong> means the software program provided by the Company downloaded by You to
                  a Device, named shoPHP</p>
              </li>
              <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                  &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to LeryLoiCompany LLC, Kitchen.</p>
              ...
              <li>
                <p><strong>Third-Party Services</strong> means any services or content (including data, information,
                  applications and other products services) provided by a third-party that may be displayed, included or
                  made available by the Application.</p>
              </li>
              <li>
                <p><strong>You</strong> means the individual accessing or using the Application or the company, or other
                  legal entity on behalf of which such individual is accessing or using the Application, as applicable.
                </p>
              </li>
            </ul>
            ...
            <p>This Agreement will terminate immediately, without prior notice from the Company, in the event that you
              ...
              Application and all copies thereof from your Device or from your computer.</p>
            ...
            <p>You agree to indemnify and hold the Company and its parents, subsidiaries, affiliates, officers,
              ...
              Agreement or any law or regulation; or (c) violation of any right of a third party.</p>
            <h1>No Warranties</h1>
            ...
            <p>Some jurisdictions do not allow the exclusion of certain types of warranties or limitations on applicable
              ...
              greatest extent enforceable under applicable law. To the extent any warranty exists under law that cannot
              be disclaimed, the Company shall be solely responsible for such warranty.</p>
            ...
            <p>Notwithstanding any damages that You might incur, the entire liability of the Company and any of its
              ...
              be limited to the amount actually paid by You for the Application or through the Application or 100 USD if
              You haven't purchased anything through the Application.</p>
            <p>To the maximum extent permitted by applicable law, in no event shall the Company or its suppliers be
              ...
              the Application, third-party software and/or third-party hardware used with the Application, or otherwise
              in connection with any provision of this Agreement), even if the Company or any supplier has been advised
            ...
            <p>Except as provided herein, the failure to exercise a right or to require performance of an obligation
              ...
              at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.</p>
            ...
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPEHu0pfTMhTZD1RlVsllbVQufgXrXCt5HFA&usqp=CAU"
              alt="alternatetext">
          </div>
        </div>
        <!-- Tab content -->
